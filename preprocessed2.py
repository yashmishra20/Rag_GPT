...
# New function to get PDFs from a directory
...
# Modify the get_pdf_text function to work with file paths
...
def main():
    ...
    # Specify the directory where your PDFs are located
    pdf_directory = "C:/Users/Yash mishra/Desktop/PROJECTS/Rag GPT/Rag GPT/data/docs"

    # Process PDFs automatically when the app starts
